...
{/* here */}
  ...
  <div   className="flex flex-col border-l-2 border-gray-200 pl-4" >
             ...
             >BENIN CITY SHOWROOMS</h4>
                  ...
                  Main Showroom
                  {/* </br> */}
                                        <p  className="text-gray-500 cursor-pointer flex text-sm leading-4 pt-3" > 
                  
                          <svg className="w-6 h-6 hover:text-primary-100 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z" />
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" />
                                      </svg>
                                          154 Ademola Adetokunbo Crescent (Opposite Swiss embassy). <br/> Wuse II</p>
                                    </li>
                                    <li className="text-xl font-medium text-gray-600 ">
                                   {/*  <i className="fa fa-circle" aria-hidden="true" style="margin-right: 5px;     margin-right: 11px font-size: 12px;"></i> */}
                  Mission Road Showroom <br />
                                        <p className="flex cursor-pointer text-gray-500 text-sm leading-4 pt-3">
                                          <svg className="w-6 h-6 hover:text-primary-100 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z" />
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" />
                                      </svg>
                                          28 Alexandria Crescent, <br/> Wuse II</p>
                                    </li>
                                    <li className="text-xl font-medium text-gray-600 ">
                                   {/*  <i className="fa fa-circle" aria-hidden="true" style="margin-right: 5px;     margin-right: 11px font-size: 12px;"></i> */}
                  Mission Road Showroom <br />
